 ...
 * 
 */
@WebServiceClient(name = "ServicioWsImplService", targetNamespace = "http://services.soap/", wsdlLocation = "http://localhost:8080/72.SOAP-JAX-WS-1.0-SNAPSHOT/ServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.soap/", "ServicioWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/72.SOAP-JAX-WS-1.0-SNAPSHOT/ServicioWsImpl?wsdl");
    ...
    public ServicioWs getServicioWsImplPort() {
        return super.getPort(new QName("http://services.soap/", "ServicioWsImplPort"), ServicioWs.class);
    }
    ...
    public ServicioWs getServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.soap/", "ServicioWsImplPort"), ServicioWs.class, features);
    }
