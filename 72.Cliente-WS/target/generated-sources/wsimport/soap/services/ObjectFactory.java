...
public class ObjectFactory {
    ...
    private final static QName _Crear_QNAME = new QName("http://services.soap/", "crear");
    private final static QName _CrearResponse_QNAME = new QName("http://services.soap/", "crearResponse");
    private final static QName _Listar_QNAME = new QName("http://services.soap/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.soap/", "listarResponse");
    private final static QName _Saludar_QNAME = new QName("http://services.soap/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://services.soap/", "saludarResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "crear")
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "crearResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "listarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "saludar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.soap/", name = "saludarResponse")
