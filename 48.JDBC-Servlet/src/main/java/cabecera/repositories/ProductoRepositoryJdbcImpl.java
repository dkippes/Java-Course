...
public class ProductoRepositoryJdbcImpl implements Repository<Producto> {
    ...
    public List<Producto> listar() throws SQLException {
        ...
        try (
                ...
                ResultSet rs = stmt.executeQuery("SELECT p.*, c.nombre FROM productos p" +
    ...
    public Producto porId(Long id) throws SQLException {
        ...
        try (
                PreparedStatement stmt = conn.prepareStatement("SELECT p.*, c.nombre FROM productos p" +
    ...
    private Producto getProducto(ResultSet rs) throws SQLException {
        ...
        p.setTipo(rs.getString("c.nombre"));
        return p;
    }
}
